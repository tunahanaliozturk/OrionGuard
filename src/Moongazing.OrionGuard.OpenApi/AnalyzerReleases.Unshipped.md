...
OG1012  | OrionGuard.OpenApi | Warning | The [OpenApiValidator] target is nested inside a type whose kind cannot be reopened as a partial declaration (only class, struct, record, record struct, and interface are supported); no validator was generated.
